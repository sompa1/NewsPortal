        ...
        public SeedService()
        {
            News = new List<News>()
            {
                new News
                {
                    ...
                    AuthorId = Authors[@"Melissa Jeltsen"].Id,
                    ...
                    CategoryId = Categories[@"Crime"].Id,
                ...
                new News
                {
                    ...
                    AuthorId = Authors[@"Andy McDonald"].Id,
                ...
                new News
                {
                    ...
                    AuthorId = Authors[@"Karen Pinchin"].Id,
                    ...
                    CategoryId = Categories[@"Impact"].Id,
