...
namespace NewsPortal.Dal.Migrations
{
    ...
    [Migration("20201128223805_seed2")]
    partial class seed2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsPortal.Model.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            ExpirationDate = new DateTime(2021, 5, 26, 7, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NewsPortal.Model.Author", b =>
                {
                    b.HasBaseType("NewsPortal.Model.User");
            ...
            modelBuilder.Entity("NewsPortal.Model.News", b =>
                {
                    b.HasOne("NewsPortal.Model.Author", "Author")
                        .WithMany("News")
